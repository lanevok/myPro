 ...
 *
 * 【問題概要】
 * まず，チェスをイメージする．ここでは，1つのクイーン(Q)が盤面を移動することを考える．
 ...
 * クイーンの移動できるマスは，障害物として配置されているポーン(P)を含めたコマがないマスであり，
 * チェスと同様に縦横四方向に加え，斜め四方向に移動可能で，コマを飛び越すことはできない．
 *
 * 【解法】
 ...
 * ビショップについては，全てのクイーンに訪問していた場合のみ，ビショップの隣接マスかどうか判定し，
 * 隣接マスであれば，経路が見つかったこととする．
